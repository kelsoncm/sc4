...
Imports the module and class identified by `full_class_name` and returns a new instance,
forwarding any extra positional or keyword arguments to the constructor.
