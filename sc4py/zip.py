...
def unzip_content(content: bytes, file_id: int | str = 0, encoding: str = "utf-8") -> str | bytes:
    ...
    Returns:
        str | bytes: O conteúdo do arquivo descompactado, decodificado como string se encoding for especificado,
...
def unzip_csv_content(content: bytes, file_id: int | str = 0, encoding: str = "utf-8", **kwargs) -> list[dict]:
    """
    Descompacta o conteúdo de um arquivo zip, lê o conteúdo do arquivo CSV especificado por file_id e retorna uma
